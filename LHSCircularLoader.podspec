#
#  Be sure to run `pod spec lint LHSCircularLoader.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
1. Display the picture with a circular animation 
2. Display the circular loading progress for a picture from a URL.
                   DESC

  s.homepage     = "https://github.com/huashanbayern/LHSCircularLoader"
